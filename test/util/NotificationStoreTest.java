...
public class NotificationStoreTest {
  ...
  @Test
  public void constructsWithFile() {
    File f = mock(File.class);
    NotificationStore store = new NotificationStore(f, 10);

    assertEquals(f, store.getFile());
    assertEquals(10, store.getWriteInterval());
  }

  @Test
  public void constructsWithFileName() {
    File f = new File("foo");
    NotificationStore store = new NotificationStore("foo", 10);
